...
lab.controller('LabCtrl', function ($scope, $http) {
    ...
    $http.get('http://localhost:85/words/noun').success(function(data) {
        $scope.noun1 = data;
    });
    $http.get('http://localhost:85/words/noun').success(function(data) {
        $scope.noun2 = data;
    });
    $http.get('http://localhost:85/words/adjectives').success(function(data) {
    ...
    $http.get('http://localhost:85/words/verb').success(function(data) {
        $scope.verb = data;
    });
